    ...
    <div class="az-column-signup">
        ...
        <div class="az-signup-header">
            ...
            <form action="" id="formid">
                ...
                <div class="form-group mb-2">
                    <label>OTP</label>
                    <input type="text" class="form-control" name="code" id="code" placeholder="Enter your OTP" required>
                </div><!-- form-group -->
...
<?php echo view('common_script/formsubmit', ['formid' => 'formid', 'submitbtn' => 'submitbtn', 'formurl' => 'otp']); ?>