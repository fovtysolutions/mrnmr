...
class Settings extends \CodeIgniter\Controller
{
    public function __construct()
    {
        ...
        $this->model = new \Core\Settings\Models\SettingsModel();
    ...
    public function index()
    {
        ...
        $contentdetails = [
            ...
            'td' => json_encode(["rolename"]),
        ];
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view('Core\Settings\Views\Settingspage', $contentdetails)
        ];
    ...
    public function add()
    {
        ...
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view('Core\Settings\Views\content', $addDatas)
        ];
        return view('Core\Settings\Views\index', $data);
    }
