<?php
namespace Core\Calendar\Controllers;
use App\Controllers\PeginationController;

class Calendar extends \CodeIgniter\Controller
{
    public function __construct()
    {
        $this->config = include realpath(__DIR__ . "/../Config.php");
        $this->model = new \Core\Calendar\Models\CalendarModel();
    ...
    public function index()
    {
        ...
        $data = [
            ...
            "content" => view('Core\Calendar\Views\frontpage', $contentdetails)
        ];
        return view('Core\Calendar\Views\index', $data);
    }
    ...
    public function add()
    {
        ...
        $data = [
            "title" => $this->config['name'],
            "desc" => $this->config['desc'],
            "content" => view('Core\Calendar\Views\content', $addDatas)
        ];
        return view('Core\Calendar\Views\index', $data);
    }
