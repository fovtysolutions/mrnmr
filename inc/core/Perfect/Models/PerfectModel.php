<?php
namespace Core\Perfect\Models;
use CodeIgniter\Model;

class PerfectModel extends Model
{
    ...
    public function getById($id){
        $query = $this->db->table('mymrperfect')->where('id', $id)->get();
        return $query->getRow(); 
    } 
    ...
    {
        return $this->db->table('mymrperfect')->where('id', $id)->delete();
    }
}
