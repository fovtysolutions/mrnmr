...
<?= $this->section("content")?>    
        <div class="az-content-body az-content-body-dashboard-six">
            <div class="card-body-container">
                ...
                <?php 
                    $usedid = $masterkey;
                    $ids = ["mrnmr_id","registration_date","first_name","last_name","membership_status","personal_interview_date","days_to_reg_end","dob","age","height","weight","location","education","profession","annual_income","food_pref","smoker","drinker","hobbies","religion","political_ideology","family_info","describe_d","past_relationship","photo","email","phone","sexual_position","anal_sex_mandatory","out_to_parents","degree_of_openness","relationship_type","want_to_get_married","want_to_have_children","idea_of_romance","social_media_handles","pet_friendly","have_children","previous_marriage","hiv_status"];
                    $requireids = [];
