        ...
        <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="education" name="education"
                            placeholder="Enter Education" value="<?= $data['education'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="annual_income" name="annual_income"
                            placeholder="Enter Annual Income" value="<?= $data['annual_income'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="food_pref" name="food_pref"
                            placeholder="Enter Food Preference" value="<?= $data['food_pref'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="religion" name="religion"
                            placeholder="Enter Religion" value="<?= $data['religion'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="degree_of_openness"
                            name="degree_of_openness" placeholder="Enter Degree of Openness"
                            value="<?= $data['degree_of_openness'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="ideology" name="ideology"
                            placeholder="Enter Ideology" value="<?= $data['ideology'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control form-control-sm" id="past_relationship" name="past_relationship"
                            placeholder="Enter Past Relationship Information" <?= $data['past_relationship'] ?? '' ?>></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="url" class="form-control form-control-sm" id="instagram_link" name="instagram_link"
                            placeholder="Enter Instagram URL" value="<?= $data['instagram_link'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="url" class="form-control form-control-sm" id="facebook_link" name="facebook_link"
                            placeholder="Enter Facebook URL" value="<?= $data['facebook_link'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control form-control-sm" id="partner_age" name="partner_age"
                            placeholder="Enter Partner Age" value="<?= $data['partner_age'] ?? '' ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="partner_education"
                            name="partner_education" placeholder="Enter Education"
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="partner_food_pref"
                            name="partner_food_pref" placeholder="Enter Food Preference"
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="partner_degree_of_openness"
                            name="partner_degree_of_openness" placeholder="Enter Degree of Openness"
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="partner_religion"
                            name="partner_religion" placeholder="Enter Religion"
            ...
            <div class="col-md-6 col-xl-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="partner_ideology"
                            name="partner_ideology" placeholder="Enter Ideology"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control form-control-sm" id="partner_describe_d" name="partner_describe_d"
                            placeholder="Describe Your Partner" <?= $data['partner_describe_d'] ?? '' ?>></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-xl-8">
                <div class="form-group row d-flex flex-column gap-2">
                    <label for="partner_us_to_consider" class="col-sm-12 col-form-label">Anything else you would want us
                        to
