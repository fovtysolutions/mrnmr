    ...
    <div class="az-header-right">
      ...
      <div class="dropdown az-profile-menu">
        ...
        <div class="dropdown-menu">
          ...
          <a href="<?= base_url('/profile/1') ?>" class="dropdown-item"><i class="typcn typcn-user-outline"></i> My
            Profile</a>
          <a href="<?= base_url('/profile/2') ?>" class="dropdown-item"><i class="typcn typcn-edit"></i> Edit
            Profile</a>
